...
export default function About() {
  return (
    <Layout>
      ...
      <img src={Panda} />
      <BodyCopy>
        I have 10 years of experience in recruitment and for the last 6 years
        have specialised in Digital Transformation. Having worked as a senior
        leader in a number of different sized recruitment agencies and managing
        teams of recruiters, I decided to set up Panda, my own recruitment
      ...
      <BodyCopy>
        Fixed fees mean you have certainty on your own costs when you engage me
        to find a candidate and I can act genuinely in the interests of my
        client and the candidate when it comes to negotiating salaries at offer
        stage. You know if I tell you a candidate&#39;s expectations that the
        information is only in the interests of the candidate and not because an
        uplift on the candidate&#39;s salary would increase my fee.
      </BodyCopy>
    </Layout>
  )
}
